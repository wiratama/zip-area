        ...
        <table class="form-table">
            <tbody>
                ...
                <tr class="row-kecamatan">
                    ...
                    <td>
                        <input type="text" name="kecamatan" id="kecamatan" class="regular-text" placeholder="<?php echo esc_attr( '', 'arwir' ); ?>" value="<?php echo esc_attr( $item->kecamatan ); ?>" required="required" />
                    </td>
                </tr>
